...
| `GEMINI_MODEL` | `gemini-3.1-flash-lite` | Which free-tier-eligible Gemini model to call |
...
`app/interview/llm.py` calls Google's free-tier Gemini API (`gemini-3.1-flash-lite` by default)
