...
| `GEMINI_MODEL` | `gemini-2.5-flash-lite` | Which free-tier-eligible Gemini model to call |
...
`app/interview/llm.py` calls Google's free-tier Gemini API (`gemini-2.5-flash-lite` by default)
